                                        ...
                                        <AccordionItem value="item-2">
                                            ...
                                            <AccordionContent className="space-y-4 pt-4">
                                                ...
                                                <div className="grid md:grid-cols-3 gap-4">
                                                    ...
                                                    <div className="space-y-2"><Label htmlFor="peso"><Scale className="inline-block mr-2 w-4 h-4"/>Peso (kg)</Label><Input id="peso" type="number" step="0.1" value={currentFormData.peso} onChange={e => handleFormChange('peso', e.target.value)} placeholder="70.5" /></div>
                                                </div>
                                                <div className="grid md:grid-cols-2 gap-4">
