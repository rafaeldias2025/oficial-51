...
// Hook removido - usando GoogleFitConnection diretamente
...
export const BeneficiosVisuais: React.FC = () => {
  ...
  // Estado simplificado para Google Fit
  ...
  const handleGoogleFitConnect = async (email: string) => {
    console.log('Google Fit conectado:', email);
    setHealthState({ isConnected: true, isLoading: false });
  };
