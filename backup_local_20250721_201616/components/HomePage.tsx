...
import { Star, Users, Target, Heart, Sparkles, ArrowRight, Brain, Salad, Dumbbell, HeartHandshake, Crown, User, Trophy, Activity, TrendingUp, Shield, Zap, ChevronRight, Play, CheckCircle, Scale, LineChart, Flame, Medal, BarChart3, Waves, Sunrise, Moon, Coffee } from 'lucide-react';
...
const ImpactStats = () => <motion.div initial={{
  opacity: 0,
  y: 20
}} animate={{
  opacity: 1,
  ...
  }].map((stat, index) => <Card key={index} className="glass-effect card-hover p-6 text-center border-0 shadow-lg">
...
const FeatureCard = ({
  ...
  color: string;
  delay: number;
}) => <motion.div className="glass-effect card-hover p-6 transition-all duration-300" initial={{
  opacity: 0,
  y: 30
}} animate={{
  opacity: 1,
...
const LiveRanking = () => {
  ...
  return <motion.div className="glass-card p-6" initial={{
    opacity: 0,
    x: -20
  }} animate={{
    opacity: 1,
    ...
    delay: 0.4
      ...
      <div className="space-y-4">
        {topUsers.map((user, index) => <motion.div key={user.name} className="flex items-center justify-between p-3 bg-netflix-hover rounded-lg" initial={{
        opacity: 0,
        x: -20
      }} animate={{
        opacity: 1,
...
const VisualBenefits = () => {
  ...
  return <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      {benefits.map((benefit, index) => <FeatureCard key={benefit.title} icon={benefit.icon} title={benefit.title} description={benefit.description} color={benefit.color} delay={index * 0.1} />)}
    </div>;
};
...
const HomePage = () => {
  ...
  return <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div className="absolute -top-40 -right-40 w-80 h-80 bg-brand-100/50 rounded-full blur-3xl" animate={{
        scale: [1, 1.2, 1],
        opacity: [0.3, 0.5, 0.3]
      }} transition={{
        duration: 8,
        ...
        <motion.div className="absolute -bottom-40 -left-40 w-80 h-80 bg-mindful-100/50 rounded-full blur-3xl" animate={{
        scale: [1.2, 1, 1.2],
        opacity: [0.5, 0.3, 0.5]
      }} transition={{
        duration: 8,
      ...
      <header className="relative z-50 border-b border-border bg-background/80 backdrop-blur-lg">
        <div className="container mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            ...
            <motion.nav className="flex gap-6 items-center" initial={{
            opacity: 0,
            x: 20
          }} animate={{
            opacity: 1,
            ...
            delay: 0.1
              ...
              {user ? <Link to="/dashboard">
                  <Button className="bg-primary hover:bg-primary/90 text-zinc-950">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            duration: 0.8
              ...
              <div className="space-y-6">
                ...
                <motion.p className="text-xl text-muted-foreground leading-relaxed max-w-2xl" initial={{
                opacity: 0,
                y: 20
              }} animate={{
                opacity: 1,
                ...
                <motion.div className="bg-gradient-to-r from-ocean-500/10 to-mindful-500/10 border border-ocean-500/20 rounded-lg p-4" initial={{
                opacity: 0,
                y: 20
              }} animate={{
                opacity: 1,
              ...
              delay: 0.8
                ...
                <Link to={user ? "/dashboard" : "/auth"} className="flex-1 sm:flex-none">
                  <Button size="lg" className="w-full sm:w-auto gradient-wellness hover:scale-105 text-white px-8 py-6 text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 animate-pulse" onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}>
                    <Sparkles className="mr-2 h-5 w-5" />
                    {user ? "ENTREM EM CONTATO" : "🚀 COMEÇAR TRANSFORMAÇÃO GRÁTIS"}
                    <ArrowRight className={`ml-2 h-5 w-5 transition-transform duration-300 ${isHovered ? 'translate-x-1' : ''}`} />
                  </Button>
                </Link>
                
                <Link to="/ranking" className="flex-1 sm:flex-none">
                  <Button variant="outline" size="lg" className="w-full sm:w-auto border-2 border-energy-400 text-energy-400 hover:bg-energy-400/10 px-8 py-6 text-lg font-semibold">
            ...
            delay: 0.4
              ...
              <div className="relative z-10">
                <img src={butterflyHero} alt="Transformação" className="w-full max-w-lg mx-auto animate-float" />
              </div>
              
              {/* Floating Elements */}
              <motion.div className="absolute -top-4 -right-4 glass-card p-4 bg-health-success/20" animate={{
              y: [0, -10, 0]
            }} transition={{
              duration: 2,
              repeat: Infinity,
              ...
              <motion.div className="absolute -bottom-4 -left-4 glass-card p-4 bg-health-warning/20" animate={{
              y: [0, -15, 0]
            }} transition={{
              duration: 2,
              repeat: Infinity,
      ...
      <section className="py-20 bg-netflix-card/20">
        <div className="container mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <motion.div className="glass-card overflow-hidden group hover:scale-105 transition-all duration-300" initial={{
            opacity: 0,
            y: 30
          }} animate={{
            opacity: 1,
            ...
            delay: 0.1
              ...
              <div className="aspect-[4/3] overflow-hidden">
                <img src={mirrorReflection} alt="Processo de Recomeço" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
              </div>
              <div className="p-6">
            ...
            delay: 0.2
              ...
              <div className="aspect-[4/3] overflow-hidden">
                <img src={groupSilhouette} alt="Terapia e Autoconhecimento" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
              </div>
              <div className="p-6">
                <h3 className="text-xl font-bold text-foreground mb-3 flex items-center">
            ...
            delay: 0.3
              ...
              <div className="aspect-[4/3] overflow-hidden">
                <img src={pilatesEquipment} alt="Atividade Física" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
              </div>
              <div className="p-6">
                <h3 className="text-xl font-bold text-foreground mb-3 flex items-center">
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-health-purple relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          duration: 0.6
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/auth">
                <Button size="lg" className="bg-white text-primary hover:bg-white/90 px-12 py-6 text-xl font-bold shadow-xl hover:shadow-2xl transition-all duration-300">
              ...
              <Link to="/courses">
                <Button size="lg" className="bg-gradient-to-r from-purple-600 to-pink-600 text-white hover:from-purple-700 hover:to-pink-700 px-12 py-6 text-xl font-bold shadow-xl hover:shadow-2xl transition-all duration-300">
              ...
              <Link to="/ranking">
                <Button variant="outline" size="lg" className="border-white text-white hover:bg-white/10 px-12 py-6 text-xl font-bold">
        ...
        {/* Floating Elements */}
        <motion.div className="absolute top-20 left-20 w-16 h-16 bg-white/10 rounded-full flex items-center justify-center" animate={{
        y: [0, -20, 0]
      }} transition={{
        duration: 3,
        repeat: Infinity,
        ...
        <motion.div className="absolute bottom-20 right-20 w-20 h-20 bg-white/10 rounded-full flex items-center justify-center" animate={{
        y: [0, -25, 0]
      }} transition={{
        duration: 3,
        repeat: Infinity,
      ...
      <footer className="py-12 bg-netflix-card border-t border-netflix-border">
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <motion.div className="flex items-center gap-3 mb-4 md:mb-0" initial={{
            opacity: 0,
            y: 20
          }} animate={{
            opacity: 1,
            ...
            <motion.div className="text-netflix-text-muted" initial={{
            opacity: 0,
            y: 20
          }} animate={{
            opacity: 1,
